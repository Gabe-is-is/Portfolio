            ...
            <div class="coluna20">
                <div class="contate-me-grid-1">
                    <div class="contate-me-border">
                        ...
                        <div>
                            <div class="localizacao-contate-me"><svg xmlns="http://www.w3.org/2000/svg" width="20px"
                                    height="20px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="svg-contate-me">
                                    <path
                            ...
                            <div class="telefone-contate-me"><svg xmlns="http://www.w3.org/2000/svg" width="20px"
                                    height="20px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="svg-contate-me">
                                    <path
                        ...
                        <div class="padding-contate-me">
                            ...
                            <form id="formContato" method="POST" action="{{ route('admin.contacts.create') }}">
                                ...
                                <div class="contate-me-assunto-container">
                                    ...
                                    <input class="contate-me-input-3" placeholder="Assunto da mensagem" name="subject">
                                </div>
                                <div class="contate-me-mensagem-container">
                                    <label for="message">Mensagem</label>
                                    <textarea name="message" placeholder="Sua mensagem..." rows="6"></textarea>
                                </div>
                                <button class="contate-me-botao" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
...
<script>
    document.getElementById('formContato').addEventListener('submit', function (event) {
        ...
        const confirmar = confirm('Tem certeza que deseja enviar esta mensagem?');
